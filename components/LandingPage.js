            ...
            <section className="bg-gray-200">
                <div className="max-w-screen-lg w-11/12  m-auto sm:flex  py-20 sm:py-4">
                    <div className="w-9/12 sm:w-1/2   pl-3 md:pl-0  m-auto ">
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-3 font-extrabold font-Bebas ">We are beyond emagination.</h1>
                        ...
                        <button className="py-2 focus:outline-none px-6 font-lg  rounded-full text-white bg-blue-500 hover:bg-black transition  duration-300 ease-in-out outline-none">Shop now</button>
                    </div>
